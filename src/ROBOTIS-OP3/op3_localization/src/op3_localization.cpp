...
void OP3Localization::process()
{
  ...
  // converte o tempo do header (builtin_interfaces::msg::Time) em rclcpp::Time
  rclcpp::Time t(pelvis_pose_.header.stamp);
  // agora soma com o Duration
  rclcpp::Time transform_expiration = t + transform_tolerance;
